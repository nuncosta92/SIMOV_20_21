...
public class Stores {
    ...
    public Stores(String id, String nome, String morada, String localidade, String cidade, String email, String tlm, String tlf) {
        this.id = id;
        this.nome = nome;
        this.morada = morada;
    ...
    public boolean validateStore() {
        if (!validateId() || !validateTlf() || !validateTlm())
            return false;
